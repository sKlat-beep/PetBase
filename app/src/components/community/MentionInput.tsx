  ...
  while ((match = re.exec(content)) !== null) {
    ...
    parts.push(
      <button
        ...
        className="text-emerald-600 dark:text-emerald-400 font-medium hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-sky-500 rounded"
      >
        @{displayName}
      </button>,
    );
