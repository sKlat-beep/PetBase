...
description: Privacy compliance gate agent. Use when auditing tasks tagged privacy, firebase, or functions before they transition to review. Enforces PII encryption rules and tokenized avatar contract.
---
