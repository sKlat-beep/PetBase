...
export const HINTS: FeatureHint[] = [
  ...
  { id: 'health-insights', title: 'View health insights dashboard', description: 'See trends, alerts, and summaries across all your pet\'s health data.', cta: 'View insights', to: '/pets', category: 'pets', accentClasses: CATEGORY_ACCENTS.pets, prerequisite: 'log-health-record' },
  ...
  // ─── Cards ──────────────────────────────────────────────────────────────────
  { id: 'multi-pet-cards', title: 'Create a multi-pet card', description: 'Combine all your pets into a single shareable card for sitters.', cta: 'Go to cards', to: '/pets?openCards=true', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-qr-card' },
  { id: 'card-templates', title: 'Try vet/sitter/emergency templates', description: 'Pick a template designed for the situation — vet visit, pet sitter, or emergency.', cta: 'Go to cards', to: '/pets?openCards=true', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-qr-card' },
  { id: 'card-sharing', title: 'Customize sharing toggles', description: 'Control exactly which fields are visible on your shared cards.', cta: 'Go to cards', to: '/pets?openCards=true', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-qr-card' },
  { id: 'card-qr-pdf', title: 'Export QR code or PDF', description: 'Download a printable PDF or QR code to stick on your pet\'s collar.', cta: 'Go to cards', to: '/pets?openCards=true', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-qr-card' },
  { id: 'card-expiration', title: 'Set card expiration dates', description: 'Add an auto-expiry so temporary cards don\'t stay active forever.', cta: 'Go to cards', to: '/pets?openCards=true', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-qr-card' },

  // ─── Services ───────────────────────────────────────────────────────────────
  { id: 'save-services', title: 'Save favorite services', description: 'Bookmark your go-to vet, groomer, or sitter for quick access.', cta: 'Search services', to: '/search', category: 'services', accentClasses: CATEGORY_ACCENTS.services, prerequisite: 'discover-services' },
  { id: 'community-tips', title: 'Add tips for local services', description: 'Help other pet parents by sharing your experience with local providers.', cta: 'Search services', to: '/search', category: 'services', accentClasses: CATEGORY_ACCENTS.services, prerequisite: 'discover-services' },
  { id: 'emergency-filter', title: 'Use 24/7 emergency filter', description: 'Quickly find emergency vets and clinics that are open right now.', cta: 'Search services', to: '/search', category: 'services', accentClasses: CATEGORY_ACCENTS.services, prerequisite: 'discover-services' },
  ...
  // ─── Social ─────────────────────────────────────────────────────────────────
  { id: 'public-profile', title: 'Customize your public profile', description: 'Choose what other pet parents see when they visit your profile.', cta: 'Go to settings', to: '/settings', category: 'social', accentClasses: CATEGORY_ACCENTS.social, prerequisite: 'setup-profile' },
  ...
  // ─── Family ─────────────────────────────────────────────────────────────────
  { id: 'invite-family', title: 'Invite household members', description: 'Share pet management with your partner, kids, or housemates.', cta: 'Go to settings', to: '/settings', category: 'family', accentClasses: CATEGORY_ACCENTS.family, prerequisite: null },
  { id: 'parental-controls', title: 'Set up parental controls', description: 'Restrict what children in your household can access.', cta: 'Go to settings', to: '/settings', category: 'family', accentClasses: CATEGORY_ACCENTS.family, prerequisite: null },
  { id: 'audit-log', title: 'Review family audit log', description: 'See who made changes to your pets\' profiles and health records.', cta: 'Go to settings', to: '/settings', category: 'family', accentClasses: CATEGORY_ACCENTS.family, prerequisite: null },
