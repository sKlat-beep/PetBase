...
export function RightPanel() {
  ...
  return (
    <aside className="hidden xl:flex xl:flex-col w-[380px] shrink-0 h-screen sticky top-0 overflow-y-auto border-l border-outline-variant/30 bg-surface glass-morphism">
      {/* Header */}
