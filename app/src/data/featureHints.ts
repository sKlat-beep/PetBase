...
export const HINTS: FeatureHint[] = [
  ...
  // ─── Cards ──────────────────────────────────────────────────────────────────
  { id: 'multi-pet-cards', title: 'Create a multi-pet card', description: 'Combine all your pets into a single shareable card for sitters.', cta: 'Go to cards', to: '/cards', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-card' },
  { id: 'card-templates', title: 'Try vet/sitter/emergency templates', description: 'Pick a template designed for the situation — vet visit, pet sitter, or emergency.', cta: 'Go to cards', to: '/cards', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-card' },
  { id: 'card-sharing', title: 'Customize sharing toggles', description: 'Control exactly which fields are visible on your shared cards.', cta: 'Go to cards', to: '/cards', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-card' },
  { id: 'card-qr-pdf', title: 'Export QR code or PDF', description: 'Download a printable PDF or QR code to stick on your pet\'s collar.', cta: 'Go to cards', to: '/cards', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-card' },
  { id: 'card-expiration', title: 'Set card expiration dates', description: 'Add an auto-expiry so temporary cards don\'t stay active forever.', cta: 'Go to cards', to: '/cards', category: 'cards', accentClasses: CATEGORY_ACCENTS.cards, prerequisite: 'create-card' },
