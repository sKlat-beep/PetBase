    ...
    >
      <header className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-800 text-sm font-medium transition-colors self-start shrink-0"
        >
      ...
      <nav aria-label="Profile sections" className="flex flex-wrap gap-2">
        {[
          ...
          <a
            key={id}
            href={`#${id}`}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-stone-100 dark:bg-stone-700 text-stone-600 dark:text-stone-300 hover:bg-emerald-100 dark:hover:bg-emerald-900/40 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors"
          >
      ...
      <form
        ...
        className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-6"
      >
        ...
        <div className="flex items-center gap-6">
          <div className="relative group">
            <div className={`w-20 h-20 bg-stone-200 dark:bg-stone-600 overflow-hidden shrink-0 ${avatarShape === 'circle' ? 'rounded-full' : avatarShape === 'square' ? 'rounded-xl' : avatarShape === 'squircle' ? 'rounded-[1.5rem]' : 'rounded-full'} shadow-md transition-all duration-300`}>
          ...
          <div className="space-y-3 flex-1">
            <div>
              <p className="font-semibold text-lg text-stone-900 dark:text-stone-100">
                {displayName || 'Pet Parent'}
              </p>
              {profile?.username && (
                <div className="flex items-center gap-2 mt-0.5 mb-1.5">
                  <span className="text-xs font-medium text-stone-500 bg-stone-100 dark:bg-stone-800 px-2 py-0.5 rounded-md border border-stone-200 dark:border-stone-700">
                    @{profile.username.split('#')[0]}<span className="opacity-60">#{profile.username.split('#')[1]}</span>
                  </span>
                  <button type="button" onClick={() => navigator.clipboard.writeText(profile.username!)} className="text-stone-400 hover:text-emerald-500 transition-colors" title="Copy username">
            ...
            <div className="flex gap-2 text-sm bg-stone-50 dark:bg-stone-700/30 p-1.5 rounded-xl w-fit border border-stone-200 dark:border-stone-700 shadow-sm">
              {(['circle', 'square', 'squircle'] as const).map(shape => (
                <button
                  key={shape}
                  type="button"
                  onClick={() => { setAvatarShape(shape); setIsDirty(true); }}
                  className={`px-3 py-1.5 rounded-lg capitalize transition-colors font-medium ${avatarShape === shape ? 'bg-white dark:bg-stone-600 text-stone-900 dark:text-stone-100 shadow-sm border border-stone-200 dark:border-stone-500' : 'text-stone-500 dark:text-stone-400 hover:text-stone-700 dark:hover:text-stone-300'}`}
                >
                  {shape}
                </button>
              ))}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              value={user?.email || ''}
              readOnly
              className="w-full pl-10 pr-12 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-stone-50 dark:bg-stone-700/50 text-stone-400 dark:text-stone-500 cursor-not-allowed font-mono"
            />
            <button
              type="button"
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-12 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-colors font-mono"
      ...
      <div id="section-emergency" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-5">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 flex items-center gap-2">
            <HeartPulse className="w-5 h-5 text-rose-500" />
            Emergency &amp; Vet Contacts
          </h2>
          <p className="text-xs text-stone-400 dark:text-stone-500 max-w-[180px] text-right">Stored on this device only — used as fallback on pet cards</p>
        </div>

        {/* Vet Info */}
        <div className="p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-stone-600 dark:text-stone-400 mb-1">Clinic Name</label>
              <input
                type="text"
                ...
                className="w-full px-3 py-2 rounded-lg border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 text-sm focus:ring-2 focus:ring-emerald-500 outline-none"
                placeholder="Happy Paws Clinic"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-stone-600 dark:text-stone-400 mb-1">Doctor Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-medium text-stone-600 dark:text-stone-400 mb-1">Vet Phone</label>
              <input
                type="tel"
            ...
            <div>
              <label className="block text-xs font-medium text-stone-600 dark:text-stone-400 mb-1">Vet Address</label>
              <input
                type="text"
        ...
        {/* Owner phone */}
        <div>
          <label className="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-1.5 flex items-center justify-between">
            Owner / Primary Phone
            <button
              type="button"
              onClick={() => setShowEmergencyPII(!showEmergencyPII)}
              className="flex items-center gap-1.5 text-xs font-medium text-stone-400 hover:text-stone-600 dark:hover:text-stone-200 transition-colors"
            >
          ...
          <input
            ...
            className="w-full px-4 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 text-sm focus:ring-2 focus:ring-emerald-500 outline-none font-mono"
          ...
          {[0, 1].map(index => {
            ...
            return (
              <div key={index} className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-medium text-stone-500 dark:text-stone-400 mb-1">Phone</label>
                  <input
                    type={showEmergencyPII ? "tel" : "password"}
                    value={contact.phone}
                    onChange={e => updateContact('phone', e.target.value)}
                    className="w-full px-3 py-2 rounded-lg border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 text-sm focus:ring-2 focus:ring-emerald-500 outline-none font-mono"
                    placeholder="(555) 000-0000"
                  />
                </div>
              </div>
      ...
      {/* Privacy & Visibility */}
      {/* ── Notifications ─────────────────────────────────────────────────── */}
      <div id="section-notifications" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-4">
        <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 flex items-center gap-2">
        ...
        <div className="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
          <div>
            <p className="font-medium text-stone-900 dark:text-stone-100">In-app notifications</p>
        ...
        <div className="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
          <div className="flex-1 min-w-0 mr-4">
            <p className="font-medium text-stone-900 dark:text-stone-100">Email notifications</p>
            <p className="text-sm text-stone-500 dark:text-stone-400 mt-0.5">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 ${emailNotifications ? 'bg-emerald-500' : 'bg-stone-300 dark:bg-stone-600'}`}
          >
        ...
        {emailNotifications && (
          <div className="px-4 pb-2">
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-stone-50 dark:bg-stone-700/50 text-stone-900 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-colors"
            >
        ...
        <div className="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
          <div className="flex-1 min-w-0 mr-4">
            <p className="font-medium text-stone-900 dark:text-stone-100">Push notifications</p>
            <p className="text-sm text-stone-500 dark:text-stone-400 mt-0.5">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 disabled:opacity-40 disabled:cursor-not-allowed ${pushNotificationsEnabled ? 'bg-emerald-500' : 'bg-stone-300 dark:bg-stone-600'}`}
          >
        ...
        <div className="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
          <div className="flex-1 min-w-0 mr-4">
            <p className="text-sm font-medium text-stone-700 dark:text-stone-300">Sound alerts for new messages</p>
            <p className="text-xs text-stone-500 dark:text-stone-400 mt-0.5">Play a chime when a new direct message arrives</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`relative w-10 h-5 rounded-full transition-colors ${notificationSound ? 'bg-emerald-500' : 'bg-stone-300 dark:bg-stone-600'}`}
            >
      ...
      {/* ── Privacy & Visibility ──────────────────────────────────────────── */}
      <div id="section-privacy" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-4">
        <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 flex items-center gap-2">
        ...
        <div className="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
          <div>
            <p className="font-medium text-stone-900 dark:text-stone-100">Profile Visibility</p>
            <p className="text-sm text-stone-500 dark:text-stone-400 mt-0.5">
              {isPrivate
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 ${isPrivate ? 'bg-emerald-600' : 'bg-stone-300 dark:bg-stone-600'
              }`}
            role="switch"
        ...
        <div className="flex items-center justify-between px-1">
          <span className="text-sm text-stone-500 dark:text-stone-400">Current status</span>
          <span
        ...
        <div className="pt-4 border-t border-stone-100 dark:border-stone-700 space-y-3">
          ...
          <div className="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
            <div>
              <p className="font-medium text-stone-900 dark:text-stone-100">Disable direct messages</p>
              <p className="text-sm text-stone-500 dark:text-stone-400 mt-0.5">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 ${disableDMs ? 'bg-emerald-500' : 'bg-stone-300 dark:bg-stone-600'}`}
            >
          ...
          <div className="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
            <div>
              <p className="font-medium text-stone-900 dark:text-stone-100">Disable group invites</p>
              <p className="text-sm text-stone-500 dark:text-stone-400 mt-0.5">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 ${disableGroupInvites ? 'bg-emerald-500' : 'bg-stone-300 dark:bg-stone-600'}`}
            >
          ...
          <div className="flex items-center justify-between p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
            <div>
              <p className="font-medium text-stone-900 dark:text-stone-100">Show my active status</p>
              <p className="text-sm text-stone-500 dark:text-stone-400 mt-0.5">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 ${showLastActive ? 'bg-emerald-500' : 'bg-stone-300 dark:bg-stone-600'}`}
            >
        ...
        <div className="pt-4 border-t border-stone-100 dark:border-stone-700 space-y-3">
          ...
          {(profile?.blockedUsers?.length ?? 0) === 0 ? (
            <p className="text-sm text-stone-500 dark:text-stone-400 p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
              You haven't blocked anyone.
            </p>
          ) : (
            <div className="rounded-xl border border-stone-100 dark:border-stone-700 divide-y divide-stone-100 dark:divide-stone-700">
              {profile!.blockedUsers.map(blockedUid => {
                ...
                return (
                  <div key={blockedUid} className="flex items-center gap-3 px-4 py-3">
                    {/* Avatar placeholder */}
                    <div className="w-8 h-8 rounded-full bg-stone-200 dark:bg-stone-600 flex items-center justify-center shrink-0">
                      <span className="text-xs font-semibold text-stone-600 dark:text-stone-200">
                        {initials || '?'}
                      </span>
                    </div>
                    <span className="text-sm text-stone-700 dark:text-stone-300 truncate flex-1">{displayName}</span>
                    <button
                      type="button"
      ...
      {/* Security */}
      <div className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-3">
        <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 flex items-center gap-2">
        ...
        {isPasswordUser && (
          <button
            type="button"
            className="w-full flex items-center justify-between p-4 rounded-xl border border-stone-100 dark:border-stone-700 hover:bg-stone-50 dark:hover:bg-stone-700/50 transition-colors"
          >
            <div className="flex items-center gap-3">
              <Lock className="w-5 h-5 text-stone-400" />
              <div className="text-left">
                <p className="font-medium text-stone-900 dark:text-stone-100">Change Password</p>
        ...
        >
          ...
          <span className="text-xs font-medium bg-stone-100 dark:bg-stone-700 text-stone-500 dark:text-stone-400 px-2 py-1 rounded-md">
            Coming Soon
          </span>
        </button>
        <div className="py-3 border-t border-stone-100 dark:border-stone-700">
          <h3 className="text-sm font-medium text-stone-700 dark:text-stone-300 mb-1">Export Your Data</h3>
          ...
          <button
            ...
            disabled={exporting}
            className="px-4 py-2 text-sm bg-stone-100 dark:bg-stone-700 text-stone-700 dark:text-stone-300 rounded-lg hover:bg-stone-200 dark:hover:bg-stone-600 transition-colors disabled:opacity-50 flex items-center gap-2"
          >
        ...
        {signInLog.length > 0 && (
          <div className="pt-2">
            <p className="text-sm font-medium text-stone-700 dark:text-stone-300 flex items-center gap-2 mb-2">
            ...
            <ul className="space-y-2">
              {signInLog.map((entry, i) => (
                <li
                  key={i}
                  className="flex items-center justify-between p-3 rounded-xl bg-stone-50 dark:bg-stone-700/40 border border-stone-100 dark:border-stone-700 text-xs"
                >
                  <span className="text-stone-500 dark:text-stone-400 truncate max-w-[200px]" title={entry.userAgent}>
                    {shortUA(entry.userAgent)}
                  </span>
                  <span className="text-stone-400 dark:text-stone-500 shrink-0 ml-2">
      ...
      {/* Family Sharing */}
      <div id="section-family" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-5">
        <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 flex items-center gap-2">
          ...
          <>
            ...
            <div className="bg-violet-50 dark:bg-violet-950/30 border border-violet-200 dark:border-violet-800 rounded-xl p-4 space-y-3">
              ...
              {household.ownerId === user?.uid && (
                <div className="bg-white dark:bg-stone-700 rounded-lg p-3 flex items-center justify-between gap-3">
                  <div>
                    <p className="text-xs text-stone-500 dark:text-stone-400 mb-0.5">Invite Code</p>
                    <p className="font-mono text-lg font-bold tracking-widest text-stone-900 dark:text-stone-100">{household.inviteCode}</p>
                  </div>
                  <div className="flex gap-2">
                    <button
                      ...
                      className="p-2 rounded-lg bg-stone-100 dark:bg-stone-600 hover:bg-violet-100 dark:hover:bg-violet-900/40 text-stone-600 dark:text-stone-300 transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg bg-stone-100 dark:bg-stone-600 hover:bg-amber-100 dark:hover:bg-amber-900/40 text-stone-600 dark:text-stone-300 transition-colors"
                    >
            ...
            {(() => {
              ...
              const ROLE_COLORS: Record<HouseholdRole, string> = {
                ...
                'Member': 'bg-stone-100 dark:bg-stone-600 text-stone-500 dark:text-stone-400',
              };
              return (
                <div className="space-y-2">
                  <p className="text-xs font-semibold text-stone-500 dark:text-stone-400 uppercase tracking-wide">Members</p>
                  {members.map(m => {
                    ...
                    return (
                      <div key={m.uid} className="bg-stone-50 dark:bg-stone-700/50 rounded-xl overflow-hidden">
                        <div className="flex items-center gap-3 p-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-stone-800 dark:text-stone-200 truncate">{m.displayName}{isSelf ? ' (you)' : ''}</p>
                          </div>
                          ...
                          {isLeader && !isSelf && (
                            <button
                              ...
                              className="p-1.5 rounded-lg text-stone-400 hover:text-violet-500 hover:bg-violet-50 dark:hover:bg-violet-950/30 transition-colors"
                              title="Manage member"
                            >
                        ...
                        {isExpanded && isLeader && !isSelf && (
                          <div className="border-t border-stone-200 dark:border-stone-600 p-4 space-y-4">
                            {/* Role selector */}
                            <div>
                              <p className="text-xs font-semibold text-stone-500 dark:text-stone-400 mb-2 uppercase tracking-wide">Role</p>
                              <div className="flex flex-wrap gap-2">
                                {(['Extended Family', 'Child', 'Member'] as HouseholdRole[]).map(role => (
                                  <button
                                    ...
                                    disabled={hhLoading}
                                    className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${m.role === role ? ROLE_COLORS[role] + ' ring-2 ring-violet-400' : 'bg-stone-100 dark:bg-stone-700 text-stone-600 dark:text-stone-400 hover:bg-stone-200 dark:hover:bg-stone-600'}`}
                                  >
                                    {role}
                                  </button>
                                ))}
                            ...
                            {(m.role === 'Extended Family' || m.role === 'Child') && (
                              <div>
                                <p className="text-xs font-semibold text-stone-500 dark:text-stone-400 mb-2 uppercase tracking-wide">Permissions</p>
                                <div className="space-y-2">
                                  {([
                                    ...
                                    <label key={key} className="flex items-center justify-between gap-3 cursor-pointer">
                                      ...
                                      <button
                                        ...
                                        disabled={hhLoading}
                                        className={`relative w-9 h-5 rounded-full transition-colors shrink-0 ${perms[key] ? 'bg-emerald-500' : 'bg-stone-300 dark:bg-stone-600'}`}
                                      >
                            ...
                            {m.role === 'Child' && (
                              <div>
                                <p className="text-xs font-semibold text-stone-500 dark:text-stone-400 mb-2 uppercase tracking-wide">Parental Controls</p>
                                <div className="space-y-2">
                                  {([
                                    ...
                                    <label key={key} className="flex items-center justify-between gap-3 cursor-pointer">
                                      ...
                                      <button
                                        ...
                                        disabled={hhLoading}
                                        className={`relative w-9 h-5 rounded-full transition-colors shrink-0 ${parental[key] ? 'bg-rose-500' : 'bg-stone-300 dark:bg-stone-600'}`}
                                      >
            ...
            {hhView === 'idle' && (
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 rounded-xl border-2 border-dashed border-stone-200 dark:border-stone-600 hover:border-stone-400 hover:bg-stone-50 dark:hover:bg-stone-700/30 transition-colors text-sm font-medium text-stone-600 dark:text-stone-400"
                >
            ...
            {hhView === 'create' && (
              <div className="space-y-3">
                <input
                  ...
                  className="w-full px-3 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-violet-500 text-sm"
                />
                <div className="flex gap-2">
                  <button type="button" onClick={() => setHhView('idle')} className="flex-1 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 text-stone-600 dark:text-stone-400 text-sm font-medium hover:bg-stone-50 dark:hover:bg-stone-700 transition-colors">
                    Cancel
                  </button>
                  <button
                    type="button"
            ...
            {hhView === 'join' && (
              <div className="space-y-3">
                <input
                  ...
                  maxLength={6}
                  className="w-full px-3 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-violet-500 text-sm font-mono tracking-widest uppercase"
                />
                <div className="flex gap-2">
                  <button type="button" onClick={() => setHhView('idle')} className="flex-1 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 text-stone-600 dark:text-stone-400 text-sm font-medium hover:bg-stone-50 dark:hover:bg-stone-700 transition-colors">
                    Cancel
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl bg-stone-900 dark:bg-stone-100 hover:bg-stone-800 dark:hover:bg-stone-200 text-white dark:text-stone-900 text-sm font-semibold transition-colors disabled:opacity-50"
                  >
      ...
      <div id="section-appearance" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700">
        <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-4">
          Appearance
        </h2>
        <div className="p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl">
          <h3 className="text-sm font-medium text-stone-700 dark:text-stone-300 mb-3">Accent Color</h3>
            ...
            {ACCENT_COLORS.map(({ key, label, bg }) => (
              <button
                ...
                className={`w-8 h-8 rounded-full ${bg} transition-all ${
                  accentColor === key
                    ? 'ring-2 ring-offset-2 ring-stone-400 dark:ring-stone-500 scale-110'
                    : 'hover:scale-105'
                }`}
              />
            ))}
      ...
      {/* Cross-Device Sync */}
      <div id="section-sync" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-5">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 flex items-center gap-2">
            <Globe className="w-5 h-5 text-violet-600" />
            Cross-Device Sync
          </h2>
          <span className={`text-xs font-medium px-2.5 py-1 rounded-full ${vaultEnabled ? 'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400' : 'bg-stone-100 dark:bg-stone-700 text-stone-500 dark:text-stone-400'}`}>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
            />
          </div>
        </div>
      ...
      {/* Encrypted Backup */}
      <div id="section-data" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-4">
        <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 flex items-center gap-2">
        ...
        <div className="flex gap-3 flex-wrap">
          <button
            ...
            className="flex items-center gap-2 bg-stone-900 hover:bg-stone-800 dark:bg-stone-100 dark:hover:bg-white text-white dark:text-stone-900 px-4 py-2 rounded-xl font-medium transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 border border-stone-200 dark:border-stone-600 hover:bg-stone-50 dark:hover:bg-stone-700 text-stone-700 dark:text-stone-300 px-4 py-2 rounded-xl font-medium transition-colors"
          >
      ...
      <div id="section-logs" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-stone-100 dark:border-stone-700 space-y-4">
        ...
        <button
          ...
          className="flex items-center gap-2 text-sm font-medium text-stone-700 dark:text-stone-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors"
        >
          <Clock className="w-4 h-4" />
          My Activity
          {activityLog.length > 0 && (
            <span className="text-xs bg-stone-100 dark:bg-stone-700 text-stone-500 px-1.5 py-0.5 rounded-full">{activityLog.length}</span>
          )}
          {showPersonalLogs ? <ChevronUp className="w-4 h-4 ml-auto" /> : <ChevronDown className="w-4 h-4 ml-auto" />}
        </button>

        {showPersonalLogs && (
          <div className="rounded-xl border border-stone-100 dark:border-stone-700 overflow-hidden">
            {activityLog.length === 0 ? (
              <p className="text-sm text-stone-400 p-4">No activity logged yet.</p>
            ) : (
              <div className="divide-y divide-stone-100 dark:divide-stone-700 max-h-80 overflow-y-auto">
                {activityLog.map(entry => (
                  <div key={entry.id} className="flex items-center justify-between px-4 py-2.5 text-sm">
                    <span className="text-stone-700 dark:text-stone-300">{entry.action}</span>
                    <span className="text-stone-400 text-xs whitespace-nowrap ml-4">{formatRelativeTime(entry.timestamp)}</span>
                  </div>
                ))}
              </div>
            )}
        ...
        {household && members.find(m => m.uid === user?.uid && (m.role === 'Family Leader')) && (
          <>
            ...
            >
              ...
              Family Audit Log
              {auditLog.length > 0 && <span className="text-xs bg-stone-100 dark:bg-stone-700 text-stone-500 px-1.5 py-0.5 rounded-full">{auditLog.length}</span>}
              {showAuditLog ? <ChevronUp className="w-4 h-4 ml-auto" /> : <ChevronDown className="w-4 h-4 ml-auto" />}
            </button>
            {showAuditLog && (
              <div className="rounded-xl border border-stone-100 dark:border-stone-700 overflow-hidden">
                {auditLog.length === 0 ? (
                  <p className="text-sm text-stone-400 p-4">No audit entries yet.</p>
                ) : (
                  <div className="divide-y divide-stone-100 dark:divide-stone-700 max-h-80 overflow-y-auto">
                    {auditLog.map(entry => (
                      <div key={entry.id} className="flex items-center justify-between px-4 py-2.5 text-sm">
                        <div>
                          <span className="font-medium text-stone-700 dark:text-stone-300">{entry.actorName}</span>
                          <span className="text-stone-500 dark:text-stone-400 ml-1">— {entry.action}</span>
                        </div>
                        <span className="text-stone-400 text-xs whitespace-nowrap ml-4">{formatRelativeTime(entry.timestamp)}</span>
                      </div>
                    ))}
      ...
      {/* Danger Zone */}
      <div id="section-danger" className="bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-sm border border-rose-100 dark:border-rose-900/30 space-y-4">
      ...
      {showBackupModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <motion.div
            ...
            className="bg-white dark:bg-stone-800 rounded-2xl shadow-2xl w-full max-w-md"
          >
            ...
            <div className="p-6 space-y-4">
              {backupMode === 'export' ? (
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-1.5">Backup Password</label>
                    <input
                      type="password"
                      value={backupPassword}
                      onChange={e => setBackupPassword(e.target.value)}
                      className="w-full px-4 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                ...
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-1.5">Backup File</label>
                    <input
                      type="file"
                      ref={backupFileRef}
                      accept=".json"
                      onChange={e => setBackupFile(e.target.files?.[0] ?? null)}
                      className="w-full text-sm text-stone-600 dark:text-stone-400 file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-medium file:bg-emerald-50 dark:file:bg-emerald-950/30 file:text-emerald-700 dark:file:text-emerald-400 hover:file:bg-emerald-100"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-1.5">Backup Password</label>
            ...
            <div className="p-5 border-t border-stone-100 dark:border-stone-700 flex gap-3">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 text-stone-700 dark:text-stone-300 font-medium hover:bg-stone-50 dark:hover:bg-stone-700"
              >
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="relative bg-white dark:bg-stone-800 rounded-2xl p-6 shadow-2xl border border-stone-100 dark:border-stone-700 w-full max-w-md z-10"
          >
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-rose-500 transition-colors mb-3"
