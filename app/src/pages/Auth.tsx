  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-stone-900 dark:text-stone-100 tracking-tight">
      ...
      >
        <div className="bg-white dark:bg-stone-800 py-8 px-4 shadow-xl shadow-stone-200/50 dark:shadow-black/30 sm:rounded-2xl sm:px-10 border border-stone-100 dark:border-stone-700">
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2 border border-stone-300 dark:border-stone-600 rounded-xl bg-white dark:bg-stone-700 text-stone-900 dark:text-stone-100 placeholder:text-stone-400 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm transition-colors"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={loading}
                className="w-full flex justify-center items-center gap-3 py-2.5 px-4 border border-stone-300 dark:border-stone-600 rounded-xl shadow-sm bg-white dark:bg-stone-700 text-sm font-medium text-stone-700 dark:text-stone-200 hover:bg-stone-50 dark:hover:bg-stone-600 transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex justify-center items-center gap-3 py-2.5 px-4 border border-stone-300 dark:border-stone-600 rounded-xl shadow-sm bg-white dark:bg-stone-700 text-sm font-medium text-stone-700 dark:text-stone-200 hover:bg-stone-50 dark:hover:bg-stone-600 transition-colors disabled:opacity-50 mt-3"
              >
